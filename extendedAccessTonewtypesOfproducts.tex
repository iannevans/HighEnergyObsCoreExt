...
Using this approach, {\bf response-function} data products could be described by an {\tt ivoa.response} table.
...
A conceptual example of such an  {\tt ivoa.response} table is presented in Appendix~\ref{sec:accessoptionsappendix}.
